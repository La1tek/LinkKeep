...
ARCHIVE_STORAGE_DRIVER = os.getenv("ARCHIVE_STORAGE_DRIVER", "disk").lower()
ARCHIVE_STORAGE_DIR = os.getenv("ARCHIVE_STORAGE_DIR", "/data/archives")
ARCHIVE_S3_BUCKET = os.getenv("ARCHIVE_S3_BUCKET", "")
ARCHIVE_S3_PREFIX = os.getenv("ARCHIVE_S3_PREFIX", "linkkeep-archives")
ARCHIVE_USE_PLAYWRIGHT = os.getenv("ARCHIVE_USE_PLAYWRIGHT", "true").lower() in {"1", "true", "yes", "on"}
ARCHIVE_RETRY_COUNT = int(os.getenv("ARCHIVE_RETRY_COUNT", "2"))
ARCHIVE_RETRY_DELAY_SECONDS = float(os.getenv("ARCHIVE_RETRY_DELAY_SECONDS", "0.5"))
